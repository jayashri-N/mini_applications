...
book=[{"name":"i'm malala","ISBN":"buk1","total":1,"avail":10,"count":0},{"name":"pi","ISBN":"buk2","total":10,"avail":5,"count":1},{"name":"wings of fire","ISBN":"buk3","total":20,"avail":15,"count":2},{"name":"physics","ISBN":"buk4","total":10,"avail":3,"count":3}]
cart=[]
out=[]
trans=[]
    ...
    if x==1:
        ...
        for b in book:
            if b["name"]==nm:
                b["total"]-=1
                usr["balance"]-=100
                print("Book loss noted.\nRs.100 deducted as fine from deposit.")
    elif x==2:
        usr["balance"]-=10
        print("Card loss noted.\nRs.10 deducted as fine from deposit.")
    input("click Enter")
    sys("cls")
